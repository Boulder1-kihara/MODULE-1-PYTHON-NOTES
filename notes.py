...
# our text editor in hello.py we can add another function. input is a function that takes a prompt as an argument. We can edit our code to say
...
You can learn more in Python’s documentation on data types.
                        ...
                        COMMENTS
A comment is a line of text in your program that is ignored by the interpreter. It is a way for you to add notes to your code. Comments are not executed as part of your program.
